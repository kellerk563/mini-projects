...
const otpButton = document.getElementById('otp-dropdown');
otpButton.addEventListener('click', function() {
	if (this.classList.contains('active')) {
		this.setAttribute('aria-expanded', false);
		otpListNav.setAttribute('aria-hidden', true);
		this.classList.remove('active');
		otpListNav.classList.remove('active');
	} else {
		this.setAttribute('aria-expanded', true);
		otpListNav.setAttribute('aria-hidden', false);
		this.classList.add('active');
		otpListNav.classList.add('active');
	}
});
...
window.addEventListener('resize', function() {
	...
	if (window.innerWidth >= screenSize) {
		otpButton.setAttribute('aria-expanded', true);
		otpListNav.setAttribute('aria-hidden', false);
		otpButton.classList.add('active');
		otpListNav.classList.add('active');
	} else {
		otpButton.setAttribute('aria-expanded', false);
		otpListNav.setAttribute('aria-hidden', true);
